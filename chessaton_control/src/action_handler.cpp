...
void ActionHandler::visualize_path(moveit::planning_interface::MoveGroupInterface::Plan plan, geometry_msgs::msg::Point pos) const {
...
void ActionHandler::visualize_path(moveit::planning_interface::MoveGroupInterface::Plan plan, geometry_msgs::msg::Pose pose) const {
    moveit_visual_tools::MoveItVisualTools visual_tools(node, "chessaton_link0", "move_group_visual",
                                                        move_group_interface_arm->getRobotModel());
...
bool ActionHandler::move_to(geometry_msgs::msg::Point pos) const {
    // Basic Information
...
bool ActionHandler::move_to(geometry_msgs::msg::Pose pose) const {
    // Basic Information
    RCLCPP_INFO(logger, "Arm Planning frame: %s", move_group_interface_arm->getPlanningFrame().c_str());
    RCLCPP_INFO(logger, "End effector link: %s", move_group_interface_arm->getEndEffectorLink().c_str());
    geometry_msgs::msg::PoseStamped current_pose = move_group_interface_arm->getCurrentPose(); 
...
bool ActionHandler::move_gripper(double goal) const {
...
bool ActionHandler::move_gripper(std::string state) const {
    // Plan the move
    moveit::planning_interface::MoveGroupInterface::Plan my_plan;
    move_group_interface_hand->setPlanningTime(60);
